...
class CatalogueRepository private constructor(private val remoteDataSource: RemoteDataSource) : CatalogueDataSource {
    ...
    override fun getMovieById(movieId: String): LiveData<MovieEntity> {
        ...
        remoteDataSource.getMovie(movieId, object : RemoteDataSource.LoadMoviesCallback {
            override fun onAllMoviesReceived(movieResponses: List<MovieResponse>) {
    ...
    override fun getTvShowById(tvshowId: String): LiveData<TvShowEntity> {
        ...
        remoteDataSource.getTvShow(tvshowId, object : RemoteDataSource.LoadTvShowsCallback {
            override fun onAllTvShowsReceived(tvshowResponses: List<TvShowResponse>) {
